...
const Chapter7Bankruptcy = () => {
  return (
    <div className="bg-gray-50 min-h-screen py-10 pt-28">
      <div className="max-w-4xl mx-auto bg-white p-6 shadow-md rounded-md">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Chapter 7 Bankruptcy Petition</h1>
        <div className="text-gray-700 space-y-4">
          ...
          <p>
          In California, debtors can choose either one of two (2) systems of exemptions, whichever is most advantageous for them.  Note that these exemptions are applicable only to individual filers, and not to partnerships, corporations and limited liability companies.
          </p>
          <p>
...
export default Chapter7Bankruptcy;
